...
class AddressController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return back()->with('success', 'Address info Stored successfully');
    }
    ...
    public function edit($id)
    {
        ...
        $returnHTML = view('frontend.partial.changeaddress', $data)->render();
    ...
    public function update(Request $request, $id)
    {
        ...
        return back()->with('success', 'Address Change Successfully!');
    }
