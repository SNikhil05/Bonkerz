    ...
    */
    ...
    public function sendOtp(Request $request)
    {
        ...
        curl_setopt_array($curl, [
          ...
          CURLOPT_POSTFIELDS => "{\n  \"template_id\":\"66a153d1d6fc0502e7432782\",\n  \"short_url\":\"1\",\n  \"realTimeResponse\":\"1\",\n  \"recipients\":[\n    {\n      \"mobiles\":\"$mobile\",\n      \"otp\":\"$otp\"\n    }\n  ]\n}",
          CURLOPT_HTTPHEADER => [
        ...
        // print_r('wdw');die;
        return view('frontend.auth.otp', compact('user'))->with('success', 'We have send otp on your registerd Mobile Number');
    }
    /**
     * verify otp
     */
    ...
    {
        $requestOtp = implode('', $request->otp);
        ...
        if ($otp && !$otp->isExpired() && $otp->otp_secret == $requestOtp) {
            $otp->markAsVerified();
            Auth::login($user);
            return redirect()->route('home');
        } else {
            return redirect()->route('user.login')->with('error', 'Invalid OTP');
        }
    }
}
