...
<div class="col-lg-8 mx-auto">
    <div class="card">
        <div class="card-body p-0">
            ...
            <form class="p-4" action="{{ route('reel.update', $reel->id) }}" method="POST" enctype="multipart/form-data">

                @csrf
                <div class="form-group row">
                    <label class="col-sm-3 col-from-label" for="title">{{translate('Title')}} </label>
                    <div class="col-sm-9">
                        <input type="text" placeholder="{{translate('Title')}}" id="title" value="{{ $reel->title }}" name="title" value="" class="form-control" required>
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-md-9">
                        <div class="mb-3">
                            ...
                            <input class="form-control" accept="video/*" type="file" name="reel" id="formFile">
                        </div>
                        <div class="file-preview box sm">
                            <a href="{{ asset('storage/' . $reel->reel_path) }}" target="_blank">link</a>
                        </div>
                    </div>
                </div>
