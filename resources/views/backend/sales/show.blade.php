        ...
        <div class="card-body">
            <div class="row gutters-5">
                ...
                @if ($order->seller_id == $admin_user_id || get_setting('product_manage_by_admin') == 1)
                    ...
                    <div class="col-md-3 ml-auto">
                        <!-- <a href="{{ route('shipping.shipToTransfer', $order->id) }}" class="btn btn-primary">Ship To Transfer</a> -->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Ship To Transfer</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        <form method="post" action="{{ route('shipping.shipToTransfer') }}">
            @csrf    

            <input type="hidden" name="order_id" value="{{ $order->id }}">
    <div class="form-group">
    <label for="exampleInputEmail1">Length <small>in cm</small></label>
    <input type="text" class="form-control" name="length" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Length" required>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Breadth <small>in cm</small></label>
    <input type="text" class="form-control" name="breadth" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Breadth" required>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Height <small>in cm</small></label>
    <input type="text" class="form-control" name="height" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Height" required>
  </div>
  <div class="form-group">
    <label for="exampleInputEmail1">Weight <small>in kg</small></label>
    <input type="text" class="form-control" name="weight" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Weight" required>
  </div>
      </div>
