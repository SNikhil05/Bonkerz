            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="my__account--section__inner border-radius-10">
                         <div class="BsdkPoint">
                            <div class="account__content--title h3 mb-20">My BSDk Money</div>
                            <div class="top-img-sec text-center">
                                <img src="{{ asset('assets/frontend/img/icon/ic1.svg') }}" class="img-fluid">
                                <p class="text-uppercase">A quick and convenient way to and refund</p>
                            </div>
                            <div class="mid-img-sec">
                                ...
                                <div class="row d-flex mb-5">
                                    <div class="col text-center">
                                        <img src="{{ asset('assets/frontend/img/icon/ic4.svg') }}" class="img-fluid" style="width: 60px;">
                                        <h3>Consolidated Money</h3>
                                        <p>Refund and cashbacks in one place</p>
                                    </div>
                                    <div class="col text-center">
                                        <img src="{{ asset('assets/frontend/img/icon/ic5.svg') }}" class="img-fluid" style="width: 65px;">
                                        <h3>Many More Benefits</h3>
                                        <p>Benefits and offers on using BSDk Money</p>
                                    </div>
                                </div>
                                
                            </div>
                             <div class="total-count-sec text-center">
                                 <h2>Total BSDK Money</h2>
                                <h1>350.01</h1>
                            </div>
                        ...
                        <!--<h2 class="text-center"><strong>Total BSDK Money</strong></h2>-->
                        ...
                        <div class="account__wrapper account__wrapper--style4 border-radius-10">
                            <div class="account__content">
                                <h2 class="account__content--title h3 mb-20 mt-5">Bsdk Money History</h2>
                                        ...
                                        <tbody class="">
                                            ...
                                            <tr class="">
                                                ...
                                                <td class="border">
                                                    ...
                                                    <span class="badge py-2 bg-success px-3 fs-6">+{{ round($bsdkHistory->point/2) }}</span>
                                                    @else
                                                    <span class="badge py-2 bg-danger w-auto px-3 fs-6">-{{ round($bsdkHistory->point/2) }}</span>
                                                    @endif
