                    ...
                    <div class="shop__sidebar--widget widget__area d-none d-lg-block">
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__form--check">
                                ...
                                <li class="widget__form--check__list">
                                    <label class="widget__form--check__label text-gray" for="filter{{ $subCategory->id }}">{{ $subCategory->name }}</label>
                                    <input class="widget__form--check__input category submitfild" name="category_id" id="filter{{ $subCategory->id }}" type="checkbox" value="{{ $subCategory->id }}">
                        ...
                        <div class="single__widget widget__bg">
                            ...
                            <ul class="widget__form--check">
                                ...
                                <li class="widget__form--check__list">
                                    <label class="widget__form--check__label text-gray" for="">{{ $theam->name }}</label>
                                    <input class="widget__form--check__input category submitfild" name="category_id" id="" value="{{ $theam->id }}" type="checkbox">
                                    <span class="widget__form--checkmark"></span>
                                </li>
                                @endforeach
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="shop__header bg__gray--color px-0 mx-0 d-flex align-items-center mt-0 pt-0 justify-content-between mb-30">
                        <div class="d-block">
                            ...
                            <p class="product__showing--count m-0 p-0">Men Oversized T-Shirts <span class="text-gray">-
                                    {{ count($products) }} items</span></p>
                            <div id="output"></div>
                        </div>
                        ...
                        <div class="product__view--mode d-flex align-items-center">
                            ...
                            <div class="product__view--mode__list product__short--by align-items-center d-none d-lg-flex">
                                <div class="select shop__header--select">
                                    ...
                                    <form method="get" id="latest" action="{{ route('short') }}">
                                        <select class="product__view--select" id="dropdown" name="dropdown_filter">
                                            <option selected value="latest-{{ $parendId }}">Sort by latest</option>
                                            <option value="desc-{{ $parendId }}">min price to max price</option>
                                            <option value="asc-{{ $parendId }}"> Max price to Min Price</option>
                                        </select>
                                    </form>
...
<script>
    $(document).ready(function() {
        ...
        $('#dropdown').change(function() {
            // Trigger form submission when dropdown changes
            $('#latest').submit();
        });
