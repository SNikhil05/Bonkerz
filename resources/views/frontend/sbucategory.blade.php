...
.swiper-wrapper {
   ...
   .newsletter-new-box .right-side {
    padding: 5rem !important;
}
   .newsletter-new-box  .popup-title {
    font-size: 4.5rem;
    color: #fff;
    line-height: 50px;
    text-align: center;
 ...
 .newsletter-new-box .popup-sub-title {
    color: #fff;
    text-align: center;
    line-height: 20px;
    margin: 1.5rem 0 3.5rem 0;
}
.newsletter-new-box .form-control {
    height: 45px;
    font-size: 1.75rem;
    font-weight: 500;
    color: #222;
}
.newsletter-new-box .btn-primary {
    background: #fff;
    color: #222;
    font-size: 3rem;
    width: 100%;
...
<main class="main__content_wrapper">
                ...
                <div class="col">
                    <div class="position__relative position-relative">
                        ...
                        <div class="position-absolute top-50 translate-middle start-50 text-white text-center">
                            ...
                            <a class="primary__btn" href="{{ route('addMenbership',28) }}">Get Membership
    ...
    <section class="membership-section">
        <div class="membership-section-wrapper">
            ...
            @if (Auth::check())
            <div class="membership-footer"><a href="{{ route('membership') }}">BECOME A BSDK MEMBER</a></div>
            @else
            <div class="membership-footer"><a href="{{ route('user.login') }}">BECOME A BSDK MEMBER</a></div>
            @endif
...
<div class="newsletter__popup" data-animation="slideInUp">
    <div id="boxes" class="newsletter__popup--inner">
        ...
        <div class="newsletter-new-box d-flex">
            <div class="row">
                <div class="col-6 left-side p-0">
                     <img  class="" src="{{ asset('assets/frontend/img/banner/popup-img.jpg') }}" alt="newsletter">
                </div>
                <div class="col-6 right-side p-0">
                    <div class="popup-title text-uppercase">Place your first order</div>
                    <div class="popup-sub-title">Sign up & get 10% OFF your first order & early access to future drops!</div>
                        <form>
                              <div class="mb-3">
                                <input type="text" class="form-control" id="Name" aria-describedby="name" placeholder="YOUR FULL NAME">
                              </div>
                              <div class="mb-3">
        ...
        <!--        <img  class="newsletter__popup--thumbnail__img display-block myimg" src="{{ asset('assets/frontend/img/banner/banner22.jpg') }}" alt="newsletter-popup-thumb">-->
        <!--    </div>-->
        <!--    <div class="newsletter__popup--box__right bg-dark text-white">-->
        <!--        <h2 class="newsletter__popup--title">PLACE YOUR</h2>-->
        <!--        <h2 class="newsletter__popup--title">FIRST ORDER</h2>-->
        <!--        <div class="newsletter__popup--content">-->
        <!--            <label class="newsletter__popup--content--desc">Sign up & get 10% OFF your first order & early access to future drops!</label>-->
        <!--            <div class="newsletter__popup--subscribe" id="frm_subscribe">-->
        <!--                <a href="{{ route('user.login') }}" class="newsletter__popup--subscribe__btn">CLAIM OFFER</a>-->
        <!--            </div>-->
        <!--        </div>-->
        <!--    </div>-->
        <!--</div>-->
