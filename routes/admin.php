...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin', 'prevent-back-history']], function () {
    ...
    Route::controller(ShippingController::class)->group(function () {
        ...
        Route::post('/ship-to-transfer', 'shipToTransfer')->name('shipping.shipToTransfer');
        Route::get('/contacts', 'contact')->name('admin.contact');
    ...
    Route::controller(CategoryController::class)->group(function () {
        ...
        Route::post('/categories/theam', 'updateTheam')->name('categories.theam');

        Route::post('/categories/categoriesByType', 'categoriesByType')->name('categories.categories-by-type');
        //reel
        Route::get('/reels', 'reel')->name('getReel');
        Route::get('/add-reel', 'addReel')->name('addReel');
        Route::post('/store-reel', 'storeReel')->name('storeReel');
        Route::get('/reel-delete/{id}', 'reelDelete')->name('reel.delete');
        Route::get('/reel-edit/{id}', 'reelEdit')->name('reel.edit');
        Route::post('/reel-update/{id}', 'reelUpdate')->name('reel.update');
    });
