...
Route::post('/check-pincode', [PincodeController::class, 'checkAvailability']);

Route::get('/shipping-policy', [PincodeController::class, 'shippingPolicy'])->name('shippingpolicy');

Route::get('/terms-conditions', [PincodeController::class, 'termsConditions'])->name('termsConditions');
Route::get('/privacy-policy', [PincodeController::class, 'privacyPolicy'])->name('privacyPolicy');
Route::post('/set-consent', [PincodeController::class, 'setConsent'])->name('set.consent');
Route::get('/contact-us', [PincodeController::class, 'contactUs'])->name('contactUs');

Route::post('/contact-save', [PincodeController::class, 'contactUsStore'])->name('contactUsStore');

Route::get('/invoice-download/{id}', [HomeController::class, 'invoiceDownload'])->name('invoiceDownload');
...
Route::get('/prod-trak', [ShippingController::class, 'track']);
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::post('/users/register', 'register')->name('user.register');
    ...
    //hariom
    Route::get('/category/{slug}', 'subCategory')->name('subCategory');
    ...
    Route::get('/product-list/{category}/{subCategory}', 'productList')->name('productList');

    Route::post('/product-filter', 'productFilter')->name('productFilter');
...
Route::controller(CartController::class)->group(function () {
    ...
    Route::get('/cart/removeFromCart/{id}', 'removeFromCart')->name('cart.removeFromCart');
    Route::post('/cart/updateQuantity', 'updateQuantity')->name('cart.updateQuantity');
    Route::get('/add-member/{id}', 'addMenbership')->name('addMenbership');
});
...
Route::group(['middleware' => ['customer', 'unbanned']], function () {
    ...
    Route::group(['prefix' => 'checkout'], function () {
        Route::controller(CheckoutController::class)->group(function () {
            Route::get('/', 'checkoutProduct')->name('checkout.checkoutProduct');
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/wishlists', [WishlistController::class, 'index'])->name('user.wishlist');
    Route::get('/wishlist-remove/{id}', [WishlistController::class, 'remove'])->name('user.wishlist.remove');
    Route::get('/bsdk-money', [WishlistController::class, 'bsdkMoney'])->name('user.bsdkMoney');
    Route::get('/bsdk-point', [WishlistController::class, 'bsdkPoint'])->name('user.bsdkPoint');
